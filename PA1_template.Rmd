---
title: "Week 2 Project_Rep.Research"
...
Set the working directory followed by downloading the dataset from its url and unzipping the file to "step_data.csv". The data comes from Roger Pengs [github account](https://github.com/rdpeng/RepData_PeerAssessment1).

```{r load data}
setwd("C:/Users/jkarbowniczek/Desktop/OneDrive for Business/CODE/Coursera/Reproducible Research/Week 2")
